...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Fraction of steps (0-1) that run CFG; the rest run cond-only (guidance 1.0, "
        "skipping the unconditional forward). Speeds up generation with minimal quality "
        "impact since guidance mostly shapes the early steps. Default: full CFG.",
    )
